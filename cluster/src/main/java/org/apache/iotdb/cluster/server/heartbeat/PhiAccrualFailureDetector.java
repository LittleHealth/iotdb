...
public class PhiAccrualFailureDetector {
    ...
    /**
     * :to determine whether current follower is available.
     */
    ...
    /**
     * record member(follower/leader)'s heartbeat.
     */
    ...
    private static class HeartbeatHistory
    {
        ...
        /**
         * The class used to store the latest n heartbeats time, then to calculate the phi.
         * @param maxSampleSize: the length of the history. Like the window size, if exceeding it, just shift.
         */
